...
const translations: Record<Language, Record<string, string>> = {
    fr: {
        ...
        'hero.name': 'Andrii Z.',
        'hero.role': 'Cybersécurité · Sécurité réseau & systèmes',
        ...
        'about.level.elementary': 'A2 - Élémentaire',
    ...
    en: {
        ...
        'hero.eyebrow': 'Portfolio — 2026',
        'hero.name': 'Andrii Z.',
        'hero.role': 'Cybersecurity · Network & systems security',
        ...
        'about.level.elementary': 'A2 - Elementary',
